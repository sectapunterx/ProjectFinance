...
final public class HandlerCode {
    ...
    public static final String MENU_FILE_EDIT_ADD = "MENU_FILE_EDIT_ADD";
    public static final String MENU_FILE_EDIT_EDIT = "MENU_FILE_EDIT_EDIT";
    public static final String MENU_FILE_EDIT_DELETE = "MENU_FILE_EDIT_DELETE";
    ...
    public static final String TOOLBAR_ACCOUNTS = "TOOLBAR_OVERVIEW";
